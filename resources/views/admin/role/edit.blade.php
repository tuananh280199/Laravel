            ...
            <div class="container-fluid">
                <div class="row"> 
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control @error('display_name') is-invalid @enderror" name="display_name" rows="5" placeholder="Nhập mô tả" required>{{ $role->display_name }}</textarea>
                            @error('display_name')
                            <div class="invalid-feedback">{{$message}}</div>
                            @enderror
                        </div>
